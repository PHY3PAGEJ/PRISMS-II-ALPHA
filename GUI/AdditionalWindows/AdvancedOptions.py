...
class AdvancedOptions_class(QtWidgets.QWidget):
    ...
    def __init__(self,title,messagetitle, message,phbutton1,func1,phbutton2,func2,phbutton3,func3,col=True):
       super(AdvancedOptions_class,self).__init__()
       self.buildpopup(title,messagetitle, message,phbutton1,func1,phbutton2,func2,phbutton3,func3,col)
       self.setWindowIcon(QtGui.QIcon('GUI/Images/Logo.png'))
     
    def buildpopup(self,title,messagetitle, message,phbutton1,func1,phbutton2,func2,phbutton3,func3,col=True):
        """Build the layout of the pop up"""
        #call in widgets to build layout
        label, textbox = self.DefinePopup(title,messagetitle, message)
        button1, button2, button3 = self.Buttons(phbutton1,func1,phbutton2,func2,phbutton3,func3,col) 
        #define layouts
    ...
    def Buttons(self,phbutton1,func1,phbutton2,func2,phbutton3,func3,col=True):
